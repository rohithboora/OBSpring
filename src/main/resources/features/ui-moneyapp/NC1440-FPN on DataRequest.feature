@ui @regression
Feature: UI-NC1440-DataRequest page Fair Processing Notice

  Scenario: The user checks for FPN at data request page
    ...
    And A user clicks the "FpnLink" button on the "data-request" page
  ...
  Scenario: The user checks for FPN at data request page and clicks back
    Given authenticate with email "a@a.com" and password "123"
    When A user access "welcome" section of "everyday banking" application
    And A user clicks the "login" button on the "welcome" page
    And A user is redirected to the "login" page
	...
	"""
    And A user is redirected to the "FPN" page
    And A user clicks the "Back" button on the "FPN" page
    And A user is redirected to the "data-request" page


  Scenario: The user checks for FPN at data request page and confirms
    Given authenticate with email "a@a.com" and password "123"
    When A user access "welcome" section of "everyday banking" application
    And A user clicks the "login" button on the "welcome" page
    And A user is redirected to the "login" page
    ...
    Then A user is redirected to the "obac-nbs" page
