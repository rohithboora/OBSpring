...
@Component
public class TermsHelper extends AbstractPageUtils implements Page {
    ...
    private String backButton = "cta-setting-btn";

    @Override
    public void go(String proposition) {
        this.driver.get(String.format("%s/terms", this.propositionsUrls.get(proposition)));
